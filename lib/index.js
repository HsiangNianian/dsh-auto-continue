...
var AutoContinueRunner = class {
  ...
  async scanInterrupted() {
    ...
    // Host readiness does not imply conversation readiness: sessions are resumed on demand from the browser; an empty pass is not a completed scan, so keep polling.
