...
var zh = {
  ...
  "field.resumeSilentTurnsHint": "回合正常结束但只有推理、既没有文本也没有工具调用时自动续跑; 这种续跑不清零连续次数, 冷却与上限照常生效。",
...
var en = {
  ...
  "field.resumeSilentTurnsHint": "Resume a turn that ended normally with reasoning only, with no text and no tool call. These resumes do not reset the consecutive count, so the cooldown and cap still apply.",
